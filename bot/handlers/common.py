...
• Пришлите аудиофайл (можно несколько сразу) — бот спросит, в какой плейлист его положить.
• Подпись к файлу <code>Исполнитель - Название</code> пропишет эти теги в трек.
• /target — плейлист, куда файлы будут загружаться сразу, без вопроса.
• FLAC, M4A, WAV и другие форматы бот сам переведёт в MP3.
